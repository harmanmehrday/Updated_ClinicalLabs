<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Services.aspx.cs" Inherits="ClinicalLabs.Services" %>
...
<body style="cursor: pointer;">
	...
	<div class="banner">
         ...
         <div class="centered">
         	...
         	<h1 class="text-center" style="margin-top:100px;">Tests Available</h1><p class="text-center" style="font-size: 22px;">Following medical tests are available.<br>> Clinical Lab\Services</p>
...
District Jalandhar, 144102</p>
	...
	<form id="form1" runat="server" class="newStyle3">
            ...
            <asp:GridView ID="GridView1" runat="server" CellPadding="3" Height="374px" Width="1176px" CssClass="grid" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px">
