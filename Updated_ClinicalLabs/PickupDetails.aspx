<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PickupDetails.aspx.cs" Inherits="ClinicalLabs.PickupDetails" %>
      ...
      <center><asp:Label ID="Label9" runat="server" Text="Label" Visible="true" ForeColor="#69cb6a" Font-Size="XX-Large" Font-Bold="true"></asp:Label></center><br/>
        ...
        <center>  <asp:Table ID="Table1" runat="server" GridLines="Both" Height="73px" Width="807px" HorizontalAlign="Center" Visible="true" CssClass="mr-0" BackColor="#B9FFC9" BackImageUrl="~/images/background.jpg" BorderStyle="Dotted">
              <asp:TableRow runat="server" HorizontalAlign="left" VerticalAlign="Middle">
                  <asp:TableCell runat="server" Width="200px" Font-Bold="true">&nbsp;&nbsp;Pickup Id</asp:TableCell>
              ...
              <asp:TableRow runat="server"  HorizontalAlign="left" VerticalAlign="Middle">
                  <asp:TableCell runat="server"  Font-Bold="true">&nbsp;&nbsp;Tests</asp:TableCell>
